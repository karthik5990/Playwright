...
export class AuthPage {
    ...
    async signUp(zip: string, first: string, last: string, email: string, password1: string, password2?: string) {
        ...
        await this.page.locator('input[name="password1"]').fill(password1);
        await this.page.locator('input[name="password2"]').fill(password2 || password1);
